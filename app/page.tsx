...
⠀⠀⠀⠀⠀⠀⣠⢶⡫⠋⠀⣠⠾⢥⢄⡤⢼⠇⢀⢞⣀⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'Very catchy name for a web viewer to format xml files from the "VESC Tool" for easier reading and sharing using a ID based system. ',
    ...
    {
      title: "ETS2LA",
      description: 'Contributor for ETS2LA, a moduler based tool for SCS trucking games. My contributions included adding Linux support, Bug fixes, and many installer improvements.',
    ...
    },
    {
      ...
      description: 'application for Maple County, a Roblox game, designed to automatically solve ATMs Puzzles.',
    ...
    },
    {
      ...
      description: 'Discord bot to help discord servers with users in multiple timezones to know each others time.',
  ...
  return (
    ...
    <div className="mt-4 ml-20">
      <span style={{ color: isDarkMode ? "white" : "black" }} className="text-1xl font-bold">~/ </span>
      <Link
        href="/"
              ...
              <div className="p-4">
                ...
                <div className="flex flex-wrap mt-4">
                  {project.tags.map((tag) => (
                    <span
                      key={tag}
                      className="bg-gray-300 dark:bg-gray-700 px-2 py-1 mr-2 mb-2 rounded-lg text-sm"
                    >
                      {tag}
                    </span>
                  ))}
